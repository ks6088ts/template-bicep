...
@description('The location for the resource group and scenario resources')
...
@description('Enable Application Insights based observability resources (Log Analytics, Application Insights, diagnostic settings, and Foundry tracing connection).')
param enableApplicationInsights bool = true

@description('Enable PostgreSQL Flexible Server resources.')
